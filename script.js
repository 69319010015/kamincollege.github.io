                ...
                saveData(formData)
                    ...
                    .catch(error => {
                        ...
                        if (error.message.includes('Network error')) {
                            ...
                            userMessage = 'เกิดข้อผิดพลาดจากเซิร์ฟเวอร์ กรุณาลองใหม่ภายหลัง';
                        }
...
function saveData(data) {
    console.log('Attempting to save data to:', window.CONFIG.SHEETS_ENDPOINT);
    console.log('Data payload:', JSON.stringify({ action: 'saveData', data: data }));
